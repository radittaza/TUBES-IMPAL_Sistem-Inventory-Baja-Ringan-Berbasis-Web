            ...
            <div class="card-body p-lg-5 p-0">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900" style = "font-weight:bold; font-size: 30px" >Bintang Makmur Abadi</h1>
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block" style="font-weight:bold;" >
                        Daftar
                    </button>
