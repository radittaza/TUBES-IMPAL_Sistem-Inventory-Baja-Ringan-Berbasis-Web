        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('stok'); ?>" name="stok" id="stok" type="number"
                            class="form-control" placeholder="Stok Barang..." min="0">
                        <?= form_error('stok', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>

                <!-- Tambahkan input untuk harga_satuan -->
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="harga_satuan">Harga Satuan</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('harga_satuan'); ?>" name="harga_satuan" id="harga_satuan"
                            type="number" step="0.01" class="form-control" placeholder="Harga Satuan...">
